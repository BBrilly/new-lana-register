...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const newData = {
      ...
      split_target_lana: parameters.split_target_lana,
      split_started_at: parameters.split_started_at,
      split_ends_at: parameters.split_ends_at,
      freeze_lana_account_above: parameters.freeze_lana_account_above,
      max_cap_lanas_on_split: parameters.max_cap_lanas_on_split,
